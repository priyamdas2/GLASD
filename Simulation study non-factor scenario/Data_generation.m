...
num_data_rep = 10;
structure_options = [2 4];  % choose from: 1 = Toeplitz, 2 = BlockToeplitz, 3 = SparseUniform, 4 = Random
dist_type = 't';      % choose: % 'gaussian_asymmetric_row', 'gaussian_asymmetric_col', 'gaussian_asymmetric_random', 't'.
